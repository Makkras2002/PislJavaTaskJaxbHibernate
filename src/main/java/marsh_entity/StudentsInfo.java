 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://www.ST.org/students}student" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "students", namespace = "http://www.ST.org/students")
public class StudentsInfo {
     ...
     * 
     */
    public List<Info> getStudent() {
        if (student == null) {
            student = new ArrayList<Info>();
        }
        return this.student;
    }
}
